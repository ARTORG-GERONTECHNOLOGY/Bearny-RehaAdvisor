...
from core.models import User, Patient, Therapist, Intervention, RehabilitationPlan, InterventionAssignment, FeedbackQuestion, Translation, PatientType
...
def setup_basic_plan(with_plan=True):
    ...
    intervention = Intervention(title='Stretching', description='desc', content_type='Video')
    intervention.save()
