...
from core.models import User, Therapist, Patient

@pytest.fixture(autouse=True, scope='function')
def mongo_mock():
    conn = connect('mongoenginetest', host='mongodb://localhost', mongo_client_class=mongomock.MongoClient)
    yield conn
    disconnect()
...
from core.models import User, Therapist
