...
FEEDBACK_QUESTIONS = [
    {
        ...
        "translations": [
            ...
            {"language": "it", "text": "Come hai trovato il contenuto?"},
    ...
    },
    {
        ...
        "translations": [
            ...
            {"language": "it", "text": "Come hai trovato l'esercizio?"},
    ...
    },
    {
        ...
        "translations": [
            ...
            {"language": "it", "text": "Il contenuto / l'esercizio era…"},
        ...
        "possibleAnswers": [
            {
                ...
                "translations": [
                    ...
                    {"language": "it", "text": "Troppo difficile"},
            ...
            },
            {
                ...
                "translations": [
                    ...
                    {"language": "it", "text": "Troppo facile"},
    ...
    },
    {
        ...
        "translations": [
            {"language": "en", "text": "How did you find the content?"},
            {"language": "de", "text": "Wie fandest du den Inhalt?"},
            {"language": "fr", "text": "Comment avez-vous trouvé le contenu ?"},
            {"language": "it", "text": "Come hai trovato il contenuto?"},
            {"language": "nl", "text": "Wat vond je van de inhoud?"},
    ...
    },
    {
        ...
        "applicable_types": ["Behavior change"],
        "translations": [
            {"language": "en", "text": "Do you intend to implement this strategy?"},
            {"language": "de", "text": "Hast du vor, diese Strategie umzusetzen?"},
            {"language": "fr", "text": "Avez-vous l'intention de mettre en œuvre cette stratégie ?"},
            {"language": "it", "text": "Hai intenzione di mettere in pratica questa strategia?"},
            {"language": "nl", "text": "Ben je van plan deze strategie toe te passen?"},
            {"language": "pt", "text": "Tenciona implementar esta estratégia?"},
        ],
        "possibleAnswers": [
            {
                "key": "yes",
                "translations": [
                    ...
                    {"language": "de", "text": "Ja"},
                    {"language": "fr", "text": "Oui"},
                    {"language": "it", "text": "Sì"},
                    {"language": "nl", "text": "Ja"},
                    {"language": "pt", "text": "Sim"},
                ],
            },
            {
                "key": "rather_yes",
                "translations": [
                    {"language": "en", "text": "Rather yes"},
                    {"language": "de", "text": "Eher ja"},
                    {"language": "fr", "text": "Plutôt oui"},
                    {"language": "it", "text": "Abbastanza sì"},
                    {"language": "nl", "text": "Eerder ja"},
                    {"language": "pt", "text": "Sim, provavelmente"},
                ],
            },
            {
                "key": "rather_no",
                "translations": [
                    {"language": "en", "text": "Rather no"},
                    {"language": "de", "text": "Eher nein"},
                    {"language": "fr", "text": "Plutôt non"},
                    {"language": "it", "text": "Abbastanza no"},
                    {"language": "nl", "text": "Eerder nee"},
                    {"language": "pt", "text": "Não, provavelmente"},
                ],
            },
            {
                "key": "no",
                "translations": [
                    ...
                    {"language": "fr", "text": "Non"},
                    {"language": "it", "text": "No"},
                    {"language": "nl", "text": "Nee"},
                    {"language": "pt", "text": "Não"},
                ],
            },
        ],
    },
    {
        ...
        "translations": [
            ...
            {"language": "it", "text": "Hai ulteriori commenti? (testo o audio)"},
