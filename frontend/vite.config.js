    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          description:
            'Bearny is a digital platform that connects patients and therapists through personalised exercise plans, remote progress monitoring, and standardised clinical assessments.',
          theme_color: '#F2F2F7',
