...
const mockStore = {
  ...
  activePatientItems: [],
  pastPatientItems: [],
  filteredActivePatientItems: [],
  filteredPastPatientItems: [],
  titleMap: {},
  typeMap: {},
  diagnoses: [],
  userLang: 'en',
  ...
  setActiveSearchTerm: jest.fn(),
  setActivePatientTypeFilter: jest.fn(),
  setActiveContentTypeFilter: jest.fn(),
  setActiveTagFilter: jest.fn(),
  setActiveBenefitForFilter: jest.fn(),
  setActiveLanguageFilter: jest.fn(),
  resetActiveFilters: jest.fn(),
  setPastSearchTerm: jest.fn(),
  setPastPatientTypeFilter: jest.fn(),
  setPastContentTypeFilter: jest.fn(),
  setPastTagFilter: jest.fn(),
  setPastBenefitForFilter: jest.fn(),
  setPastLanguageFilter: jest.fn(),
  resetPastFilters: jest.fn(),
