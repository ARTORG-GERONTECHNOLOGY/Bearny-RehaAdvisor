...
const PrivacyPolicy: React.FC = () => {
  ...
  return (
    <Layout aria-label={t('Privacy Policy')}>
      ...
      <div className="[&_p]:mb-4 [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:mb-1 [&_h4]:mt-6 [&_h4]:mb-2 [&_h4]:text-lg [&_h4]:font-semibold">
        <p>
        ...
        <p>
          Data is stored securely in compliance with ethical research standards. Access is limited
          to authorized research personnel only.
        </p>
        ...
        <ul>
          <li>
            ...
            burned, and active minutes. Used to track whether the patient is meeting their
            prescribed movement goals during rehabilitation.
          </li>
          <li>
            <strong>fitness.heart_rate.read</strong> — Resting heart rate and time spent in heart
            rate zones (fat-burn, cardio, peak). Used to verify that the patient is exercising at
            the correct intensity as specified in their rehabilitation plan.
          </li>
          <li>
            <strong>fitness.sleep.read</strong> — Sleep duration, time actually asleep, and number
            of awakenings. Sleep quality is a key recovery indicator in post-surgical
            rehabilitation.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Data is stored on servers located in <strong>Switzerland</strong> and subject to the
            same access controls as all other Bearny data.
          </li>
          <li>
