  ...
  return (
    <div className="d-flex flex-column min-vh-100">
      ...
      >
        ...
        <p className="mb-4">
          This web application is provided for research purposes only. By accessing or using this
          platform, you agree to the following terms.
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-6">1. Research Use</h2>
        <p className="mb-4">
          The application is designed to support clinical and rehabilitation research. It is not
          intended for commercial use or general medical diagnosis.
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-6">2. Data Privacy</h2>
        <p className="mb-4">
          All user data collected through this platform is handled in accordance with ethical
        ...
        <p className="mb-4">
          The application is provided "as is" without warranties of any kind. We make no guarantees
          regarding accuracy, reliability, or availability.
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-6">4. Consent</h2>
        <p className="mb-4">
          By using this platform, you consent to your data being used for scientific and academic
          purposes, in anonymized form.
        </p>

        <h2 className="text-xl font-semibold mb-2 mt-6">5. Changes</h2>
        <p className="mb-4">
          These terms may be updated periodically. Continued use of the application implies
